...
namespace MatrixUtils.Extensions
{
    ...
    public static class VectorExtensions
    {
        ...
        public static Vector3 WithX(this Vector3 input, float newX)
        {
	        input.x = newX;
	        return input;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector3 WithY(this Vector3 input, float newY)
        {
	        input.y = newY;
	        return input;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 WithX(this Vector2 input, float newX)
        {
	        input.x = newX;
	        return input;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 WithY(this Vector2 input, float newY)
        {
	        input.y = newY;
	        return input;
        }
